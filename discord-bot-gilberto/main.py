...
from bot_commands import handle_commands

# STEP 0: LOAD DISCORD TOKEN
load_dotenv()
TOKEN: Final[str] = os.getenv("DISCORD_TOKEN")

# DEFINE PATH FOR LOG FILE IN THE PROJECT ROOT
